...
export const ANXIETY_ARTICLES: Article[] = [
  {
    id: 'art-ansiedade-1',
    slug: 'o-que-e-ansiedade-e-como-ela-funciona',
    title: 'O que é ansiedade e como ela funciona',
    summary: 'Compreenda os mecanismos biológicos da ansiedade, por que o corpo reage em alerta e como transformar o medo em autoproteção equilibrada.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['ansiedade', 'sistema nervoso', 'alerta', 'luta ou fuga', 'biologia'],
    tags: ['ansiedade', 'corpo', 'mente', 'educacao'],
    relatedArticleIds: ['como-reconhecer-os-sinais-da-ansiedade', 'ansiedade-e-estresse-qual-e-a-diferenca', 'o-que-acontece-no-corpo-durante-uma-crise-de-ansiedade'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `A ansiedade é uma resposta biológica ancestral desenhada para garantir a sobrevivência humana diante de perigos reais. No entanto, na sociedade moderna repleta de estímulos contínuos, prazos e incertezas, esse alarme interno frequentemente dispara sem que haja uma ameaça física iminente.
...
*Aviso: Este conteúdo é educativo. Se a ansiedade estiver prejudicando suas atividades cotidianas, consulte um psicólogo ou médico de sua confiança.*`,
  ...
  {
    id: 'art-ansiedade-2',
    slug: 'como-reconhecer-os-sinais-da-ansiedade',
    title: 'Como reconhecer os sinais da ansiedade',
    summary: 'Aprenda a mapear os sintomas físicos, emocionais e comportamentais da ansiedade logo nos estágios iniciais antes que virem sobrecarga.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['sinais', 'sintomas', 'corpo', 'reconhecimento', 'autocuidado'],
    tags: ['ansiedade', 'sintomas', 'prevencao'],
    relatedArticleIds: ['o-que-e-ansiedade-e-como-ela-funciona', 'o-que-acontece-no-corpo-durante-uma-crise-de-ansiedade', 'como-acalmar-os-pensamentos-acelerados'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Reconhecer os primeiros indícios de ansiedade é uma das habilidades mais valiosas para manter a estabilidade emocional. Muitas vezes, a ansiedade não começa com uma crise dramática, mas sim com pequenos sussurros corporais que tendemos a ignorar no meio da pressa diária.
...
*Aviso: Este conteúdo é educativo e não substitui diagnóstico clínico.*`,
  ...
  {
    id: 'art-ansiedade-3',
    slug: 'ansiedade-e-estresse-qual-e-a-diferenca',
    title: 'Ansiedade e estresse: qual é a diferença?',
    summary: 'Entenda as distinções fundamentais entre a reação a pressões externas e a preocupação persistente interna para direcionar o cuidado certo.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['estresse', 'ansiedade', 'diferenca', 'pressao', 'causas'],
    tags: ['ansiedade', 'estresse', 'autocuidado'],
    relatedArticleIds: ['o-que-e-ansiedade-e-como-ela-funciona', 'como-lidar-com-a-preocupacao-excessiva', 'quando-procurar-ajuda-profissional'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Embora os termos "estresse" e "ansiedade" sejam frequentemente usados como sinônimos na linguagem cotidiana, na psicologia e na neurociência eles representam processos distintos, ainda que intimamente conectados. Compreender a diferença é essencial para saber qual estratégia de autocuidado aplicar em cada momento.
...
*Aviso: Este conteúdo é educativo e não substitui consulta profissional.*`,
  ...
  {
    id: 'art-ansiedade-4',
    slug: 'o-que-acontece-no-corpo-durante-uma-crise-de-ansiedade',
    title: 'O que acontece no corpo durante uma crise de ansiedade',
    summary: 'Descubra a fisiologia de um pico de ansiedade, por que os sintomas parecem tão intensos e como ancorar o corpo com segurança.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 6,
    readTimeMinutes: 6,
    keywords: ['crise', 'ataque de panico', 'taquicardia', 'fisiologia', 'seguranca'],
    tags: ['ansiedade', 'crise', 'corpo', 'acolhimento'],
    relatedArticleIds: ['o-que-e-ansiedade-e-como-ela-funciona', 'como-acalmar-os-pensamentos-acelerados', 'tecnica-5-4-3-2-1-para-voltar-ao-presente'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Uma crise de ansiedade ou ataque de pânico pode ser uma experiência assustadora. O coração dispara, o ar parece faltar e uma sensação avassaladora de perda de controle pode tomar conta. No entanto, compreender exatamente o que está ocorrendo do ponto de vista fisiológico é uma das formas mais eficazes de reduzir o medo da própria crise.
...
*Aviso: Este conteúdo é educativo. Dores no peito inéditas ou acompanhadas de irradiação para o braço devem ser avaliadas por um serviço médico para descartar causas orgânicas.*`,
  ...
  {
    id: 'art-ansiedade-5',
    slug: 'como-acalmar-os-pensamentos-acelerados',
    title: 'Como acalmar os pensamentos acelerados',
    summary: 'Técnicas cognitivas e comportamentais para diminuir a velocidade do fluxo mental e recuperar a clareza quando a cabeça não para.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['pensamentos acelerados', 'mente', 'foco', 'clareza', 'cognitivo'],
    tags: ['ansiedade', 'mente', 'foco', 'regulacao'],
    relatedArticleIds: ['como-lidar-com-a-preocupacao-excessiva', 'o-que-e-ansiedade-e-como-ela-funciona', 'como-desacelerar-a-mente-antes-de-dormir'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Você já teve a sensação de que sua mente funciona como um navegador com 40 abas abertas simultaneamente, todas tocando música e exigindo atenção? Os pensamentos acelerados são uma das manifestações mais exaustivas da ansiedade.
...
*Aviso: Este conteúdo é educativo e não substitui psicoterapia.*`,
  ...
  {
    id: 'art-ansiedade-6',
    slug: 'ansiedade-antes-de-provas-reunioes-e-apresentacoes',
    title: 'Ansiedade antes de provas, reuniões e apresentações',
    summary: 'Estratégias validadas para lidar com o nervosismo pré-desempenho, controlar a voz trêmula e transformar o medo em foco.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['provas', 'reunioes', 'apresentacao', 'desempenho', 'falar em publico'],
    tags: ['ansiedade', 'trabalho', 'estudos', 'foco'],
    relatedArticleIds: ['como-acalmar-os-pensamentos-acelerados', 'como-lidar-com-a-preocupacao-excessiva', 'tecnica-5-4-3-2-1-para-voltar-ao-presente'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `O coração acelera na sala de espera, a garganta fica seca antes de abrir o microfone em uma videoconferência ou a mente parece dar um "branco" ao receber a folha de prova. A ansiedade de desempenho é uma das experiências humanas mais universais e compreensíveis.
...
*Aviso: Este conteúdo é educativo e não substitui orientação clínica.*`,
  ...
  {
    id: 'art-ansiedade-7',
    slug: 'como-lidar-com-a-preocupacao-excessiva',
    title: 'Como lidar com a preocupação excessiva',
    summary: 'Aprenda a desarmar ciclos de ruminação mental, separar problemas solucionáveis de cenários hipotéticos e viver com mais leveza.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 6,
    readTimeMinutes: 6,
    keywords: ['preocupacao', 'ruminacao', 'controle', 'pensamento', 'futuro'],
    tags: ['ansiedade', 'cognitivo', 'habitos'],
    relatedArticleIds: ['o-que-e-ansiedade-e-como-ela-funciona', 'como-acalmar-os-pensamentos-acelerados', 'quando-procurar-ajuda-profissional'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
...
*Aviso: Este conteúdo é educativo e não substitui psicoterapia.*`,
  ...
  {
    id: 'art-ansiedade-8',
    slug: 'habitos-que-podem-aumentar-a-ansiedade',
    title: 'Hábitos que podem aumentar a ansiedade',
    summary: 'Identifique comportamentos cotidianos imperceptíveis na alimentação, rotina e uso de telas que alimentam a hiperativação do sistema nervoso.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['habitos', 'cafeina', 'telas', 'sono', 'rotina'],
    tags: ['ansiedade', 'habitos', 'estilo de vida'],
    relatedArticleIds: ['como-as-telas-afetam-a-qualidade-do-sono', 'como-criar-uma-rotina-emocionalmente-saudavel', 'o-que-e-ansiedade-e-como-ela-funciona'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Muitas vezes tratamos a ansiedade apenas como um fenômeno estritamente mental, esquecendo que o cérebro faz parte de um ecossistema biológico complexo. Pequenos hábitos diários podem, sem que você perceba, enviar mensagens contínuas de perigo para o seu sistema nervoso.
...
*Aviso: Este conteúdo é educativo e não substitui orientação médica ou nutricional.*`,
  ...
  {
    id: 'art-ansiedade-9',
    slug: 'como-apoiar-alguem-que-esta-ansioso',
    title: 'Como apoiar alguém que está ansioso',
    summary: 'Guia prático e empático sobre como acolher amigos, familiares ou parceiros em momentos de ansiedade sem invalidar seus sentimentos.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['apoio', 'empatia', 'escuta', 'relacionamentos', 'cuidado'],
    tags: ['ansiedade', 'relacoes', 'empatia'],
    relatedArticleIds: ['o-que-acontece-no-corpo-durante-uma-crise-de-ansiedade', 'o-que-e-ansiedade-e-como-ela-funciona', 'quando-procurar-ajuda-profissional'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Ver uma pessoa querida sofrer com ansiedade intensa ou atravessar uma crise pode gerar uma sensação de impotência. Muitas vezes, na tentativa genuína de ajudar, acabamos usando frases que aumentam ainda mais a angústia da outra pessoa.
...
*Aviso: Este conteúdo é educativo e não substitui atendimento profissional especializado.*`,
  },
  {
    ...
    summary: 'Compreenda os critérios clínicos e momentos em que o acompanhamento com psicólogo ou psiquiatra é o caminho mais seguro e libertador.',
    category: 'Ansiedade',
    categoryName: 'Ansiedade',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['ajuda profissional', 'psicoterapia', 'psiquiatria', 'saude mental', 'diagnostico'],
    tags: ['ansiedade', 'saude mental', 'terapia', 'cuidado'],
    relatedArticleIds: ['o-que-e-ansiedade-e-como-ela-funciona', 'como-reconhecer-os-sinais-da-ansiedade', 'o-que-acontece-no-corpo-durante-uma-crise-de-ansiedade'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Buscar apoio profissional para cuidar da saúde mental ainda é, para muitas pessoas, uma decisão cercada de dúvidas e preconceitos infundados. No entanto, assim como consultamos um médico quando temos uma dor física persistente, procurar psicoterapia ou avaliação psiquiátrica é um ato de maturidade, autocuidado e respeito pela própria história.
