...
export const SLEEP_ARTICLES: Article[] = [
  {
    id: 'art-sono-1',
    slug: 'como-desacelerar-a-mente-antes-de-dormir',
    title: 'Como desacelerar a mente antes de dormir',
    summary: 'Aprenda rituais práticos e cientificamente embasados para diminuir a rotação dos pensamentos e sinalizar ao corpo que é hora de descansar.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['sono', 'mente', 'desacelerar', 'noite', 'insonia'],
    tags: ['sono', 'mente', 'relaxamento', 'rotina'],
    relatedArticleIds: ['como-criar-uma-rotina-noturna-saudavel', 'a-relacao-entre-ansiedade-e-dificuldade-para-dormir', 'exercicios-de-respiracao-para-o-periodo-noturno'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `Deitar na cama com o corpo exausto e, no mesmo instante, ver a mente acelerar em um turbilhão de memórias, planos e preocupações é uma das queixas mais comuns da vida contemporânea. Essa transição abrupta entre um dia hiperconectado e o silêncio do travesseiro gera um choque no sistema nervoso.
...
*Aviso: Este conteúdo é educativo e não substitui consulta médica em casos de insônia crônica.*`,
  ...
  {
    id: 'art-sono-2',
    slug: 'como-criar-uma-rotina-noturna-saudavel',
    title: 'Como criar uma rotina noturna saudável',
    summary: 'Construa um passo a passo acolhedor para a sua noite que prepare seu organismo para um sono profundo, contínuo e reparador.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 6,
    readTimeMinutes: 6,
    keywords: ['rotina noturna', 'higiene do sono', 'habitos', 'descanso', 'relaxamento'],
    tags: ['sono', 'rotina', 'habitos', 'autocuidado'],
    relatedArticleIds: ['como-desacelerar-a-mente-antes-de-dormir', 'como-preparar-o-quarto-para-descansar-melhor', 'habitos-durante-o-dia-que-ajudam-a-dormir-melhor'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `Uma rotina noturna saudável — frequentemente chamada na medicina de *Higiene do Sono* — é uma sequência previsível de ações que sinaliza ao organismo que a fase ativa do dia terminou e que é seguro relaxar e descansar.
...
*Aviso: Este conteúdo é educativo e não substitui acompanhamento médico.*`,
  ...
  {
    id: 'art-sono-3',
    slug: 'a-relacao-entre-ansiedade-e-dificuldade-para-dormir',
    title: 'A relação entre ansiedade e dificuldade para dormir',
    summary: 'Entenda como o estado de hiperalerta sabota a indução do sono e como quebrar o círculo vicioso entre noites em claro e angústia diurna.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['ansiedade', 'sono', 'insonia', 'hiperalerta', 'ciclo'],
    tags: ['sono', 'ansiedade', 'mente'],
    relatedArticleIds: ['o-que-fazer-quando-o-sono-nao-chega', 'como-desacelerar-a-mente-antes-de-dormir', 'exercicios-de-respiracao-para-o-periodo-noturno'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `A ansiedade e a insônia alimentam-se mutuamente em uma das relações mais desgastantes para a saúde mental. Quando estamos ansiosos, temos dificuldade para dormir; e quando não dormimos o suficiente, nosso cérebro se torna neuroquimicamente muito mais reativo e ansioso no dia seguinte.
...
*Aviso: Este conteúdo é educativo e não substitui tratamento médico para distúrbios do sono.*`,
  ...
  {
    id: 'art-sono-4',
    slug: 'como-as-telas-afetam-a-qualidade-do-sono',
    title: 'Como as telas afetam a qualidade do sono',
    summary: 'Descubra os impactos da luz azul e do estímulo dopaminérgico dos smartphones na produção de melatonina e na profundidade do descanso.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['telas', 'luz azul', 'celular', 'melatonina', 'sono profundo'],
    tags: ['sono', 'tecnologia', 'habitos', 'saude'],
    relatedArticleIds: ['como-criar-uma-rotina-noturna-saudavel', 'por-que-acordamos-cansados-mesmo-depois-de-dormir', 'habitos-durante-o-dia-que-ajudam-a-dormir-melhor'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `O smartphone tornou-se o último objeto que tocamos antes de dormir e o primeiro que buscamos ao abrir os olhos pela manhã. No entanto, a neurociência moderna já demonstrou de forma inequívoca que a presença de telas nos momentos que antecedem o sono compromete gravemente a arquitetura do descanso.
...
*Aviso: Este conteúdo é informativo e visa a promoção de hábitos saudáveis.*`,
  ...
  {
    id: 'art-sono-5',
    slug: 'como-preparar-o-quarto-para-descansar-melhor',
    title: 'Como preparar o quarto para descansar melhor',
    summary: 'Ajustes essenciais de temperatura, iluminação, ruído e organização no seu ambiente para transformá-lo em um verdadeiro santuário do sono.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['quarto', 'ambiente', 'temperatura', 'escuridao', 'santuario do sono'],
    tags: ['sono', 'ambiente', 'habitos', 'bem-estar'],
    relatedArticleIds: ['como-criar-uma-rotina-noturna-saudavel', 'por-que-acordamos-cansados-mesmo-depois-de-dormir', 'como-desacelerar-a-mente-antes-de-dormir'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `O ambiente em que dormimos exerce uma influência silenciosa, mas decisiva, na facilidade com que adormecemos e na profundidade dos nossos ciclos de sono. Um quarto barulhento, quente ou desorganizado mantém o sistema nervoso em estado constante de microalerta.
...
*Aviso: Este conteúdo é educativo e visa o aprimoramento da higiene do sono.*`,
  ...
  {
    id: 'art-sono-6',
    slug: 'o-que-fazer-quando-o-sono-nao-chega',
    title: 'O que fazer quando o sono não chega',
    summary: 'Diretrizes comprovadas pela terapia cognitivo-comportamental para insônia sobre o que fazer ao rolar de um lado para o outro na cama.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['insonia', 'sono nao chega', 'regras', 'cama', 'controle de estimulo'],
    tags: ['sono', 'insonia', 'terapia', 'habitos'],
    relatedArticleIds: ['a-relacao-entre-ansiedade-e-dificuldade-para-dormir', 'exercicios-de-respiracao-para-o-periodo-noturno', 'como-desacelerar-a-mente-antes-de-dormir'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `Rolar de um lado para o outro na cama, virar o travesseiro para o lado frio e olhar para o teto com sensação de impotência é uma experiência frustrante. O maior erro nesses momentos é permanecer na cama lutando contra a própria vigília.
...
*Aviso: Se a dificuldade para dormir ocorrer mais de 3 vezes por semana por mais de um mês, consulte um médico especialista.*`,
  ...
  {
    id: 'art-sono-7',
    slug: 'por-que-acordamos-cansados-mesmo-depois-de-dormir',
    title: 'Por que acordamos cansados mesmo depois de dormir',
    summary: 'Entenda os fatores que fragmentam os ciclos de sono profundo e descubra como recuperar a energia e o despertar revigorado.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['acordar cansado', 'sono profundo', 'qualidade do sono', 'inércia do sono', 'energia'],
    tags: ['sono', 'energia', 'saude', 'habitos'],
    relatedArticleIds: ['a-importancia-de-manter-horarios-regulares', 'habitos-durante-o-dia-que-ajudam-a-dormir-melhor', 'como-as-telas-afetam-a-qualidade-do-sono'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `Dormir 7 ou 8 horas seguidas e ainda assim despertar com o corpo pesado, dor de cabeça e sensação de exaustão é uma experiência desanimadora. Essa queixa revela uma verdade fundamental da medicina do sono: **quantidade de horas não é sinônimo de qualidade de sono**.
...
*Aviso: Ronco frequente, engasgos noturnos e sonolência excessiva durante o dia devem ser avaliados por um médico com exame de polissonografia.*`,
  ...
  {
    id: 'art-sono-8',
    slug: 'exercicios-de-respiracao-para-o-periodo-noturno',
    title: 'Exercícios de respiração para o período noturno',
    summary: 'Técnicas de respiração cientificamente comprovadas para ativar o nervo vago, desacelerar o coração e induzir o sono.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['respiracao', '4-7-8', 'nervo vago', 'sono', 'inducao'],
    tags: ['sono', 'respiracao', 'praticas', 'relaxamento'],
    relatedArticleIds: ['como-desacelerar-a-mente-antes-de-dormir', 'a-relacao-entre-ansiedade-e-dificuldade-para-dormir', 'o-que-fazer-quando-o-sono-nao-chega'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `A respiração é a única função do sistema nervoso autônomo sobre a qual temos controle voluntário direto. Ao alterar conscientemente o ritmo e a proporção entre inspiração e expiração, enviamos um sinal neuroquímico imediato para o coração diminuir os batimentos e para o corpo desligar o estado de alerta.
...
*Aviso: Este conteúdo é educativo e voltado para a promoção do bem-estar.*`,
  ...
  {
    id: 'art-sono-9',
    slug: 'a-importancia-de-manter-horarios-regulares',
    title: 'A importância de manter horários regulares',
    summary: 'Descubra o poder do ritmo circadiano e por que dormir e acordar no mesmo horário todos os dias é o maior aliado do seu sono e humor.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['horarios regulares', 'ritmo circadiano', 'relogio biologico', 'sono', 'rotina'],
    tags: ['sono', 'habitos', 'saude', 'rotina'],
    relatedArticleIds: ['por-que-acordamos-cansados-mesmo-depois-de-dormir', 'habitos-durante-o-dia-que-ajudam-a-dormir-melhor', 'como-criar-uma-rotina-noturna-saudavel'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `O corpo humano é governado por um relógio mestre localizado no hipotálamo (o núcleo supraquiasmático), que orquestra milhares de relógios celulares em todos os nossos órgãos. Esse mecanismo intrínseco — o ritmo circadiano — adora previsibilidade e rotina.
...
*Aviso: Este conteúdo é informativo e visa o equilíbrio da rotina.*`,
  ...
  {
    id: 'art-sono-10',
    slug: 'habitos-durante-o-dia-que-ajudam-a-dormir-melhor',
    title: 'Hábitos durante o dia que ajudam a dormir melhor',
    summary: 'O sono não começa na hora de deitar, mas sim nas decisões que você toma desde o momento em que abre os olhos pela manhã.',
    category: 'Sono',
    categoryName: 'Sono',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['habitos diurnos', 'sono', 'sol', 'exercicio', 'pressao de sono'],
    tags: ['sono', 'habitos', 'estilo de vida', 'bem-estar'],
    relatedArticleIds: ['a-importancia-de-manter-horarios-regulares', 'como-as-telas-afetam-a-qualidade-do-sono', 'como-criar-uma-rotina-noturna-saudavel'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia e Medicina do Sono Respira',
    reviewedBy: 'Dr. Lucas Silveira (CRM 158.420)',
    content: `Costumamos nos preocupar com o sono apenas quando apagamos as luzes do quarto e percebemos a dificuldade para adormecer. No entanto, a neurobiologia nos ensina que a qualidade de uma boa noite de sono é construída ao longo de todas as 16 horas de vigília anteriores.
