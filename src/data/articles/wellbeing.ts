...
export const WELLBEING_ARTICLES: Article[] = [
  {
    id: 'art-bem-estar-1',
    slug: 'como-praticar-autocuidado-em-uma-rotina-corrida',
    title: 'Como praticar autocuidado em uma rotina corrida',
    summary: 'Desmistifique a ideia de que autocuidado exige horas livres e aprenda a encaixar micropráticas restauradoras nos seus dias mais cheios.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['autocuidado', 'rotina', 'tempo', 'microhabitos', 'vida corrida'],
    tags: ['bem-estar', 'autocuidado', 'habitos', 'rotina'],
    relatedArticleIds: ['a-importancia-das-pequenas-pausas-durante-o-dia', 'como-criar-uma-rotina-emocionalmente-saudavel', 'como-criar-habitos-de-autocuidado-duradouros'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Nas redes sociais, o autocuidado é frequentemente retratado como um dia inteiro em um spa, viagens longas ou rituais matinais de duas horas. Para quem equilibra trabalho, família, estudos e tarefas domésticas, essa imagem parece inalcançável e gera ainda mais frustração.
...
*Aviso: Este conteúdo é educativo e visa o desenvolvimento pessoal.*`,
  ...
  {
    id: 'art-bem-estar-2',
    slug: 'a-importancia-das-pequenas-pausas-durante-o-dia',
    title: 'A importância das pequenas pausas durante o dia',
    summary: 'Descubra a neurociência dos ritmos ultradianos e por que intervalos estratégicos de 3 minutos aumentam seu foco e previnem o esgotamento.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['pausas', 'ritmos ultradianos', 'foco', 'fadiga', 'produtividade sustentavel'],
    tags: ['bem-estar', 'produtividade', 'foco', 'habitos'],
    relatedArticleIds: ['como-praticar-autocuidado-em-uma-rotina-corrida', 'descansar-tambem-faz-parte-da-produtividade', 'como-diminuir-a-sobrecarga-mental'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Trabalhar por quatro, cinco ou seis horas ininterruptas olhando para uma tela sem levantar da cadeira costuma ser elogiado na cultura da pressa como sinal de foco absoluto. No entanto, a neurofisiologia humana não foi programada para manter a atenção sustentada sem intervalos regulares de recuperação.
...
*Aviso: Este conteúdo é educativo e focado em produtividade sustentável.*`,
  ...
  {
    id: 'art-bem-estar-3',
    slug: 'como-aprender-a-respeitar-os-proprios-limites',
    title: 'Como aprender a respeitar os próprios limites',
    summary: 'Aprenda a reconhecer seus sinais de saturação, dizer "não" com firmeza e gentileza e construir barreiras protetoras para sua energia.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['limites', 'dizer nao', 'autoestima', 'energia', 'relacoes'],
    tags: ['bem-estar', 'emocional', 'relacoes', 'autocuidado'],
    relatedArticleIds: ['como-criar-uma-rotina-emocionalmente-saudavel', 'como-ter-uma-relacao-saudavel-com-a-produtividade', 'como-diminuir-a-sobrecarga-mental'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Dizer "sim" para todas as demandas de colegas, amigos e familiares enquanto dizemos "não" para as nossas próprias necessidades básicas de descanso e saúde é uma das causas primordiais do esgotamento emocional.
...
*Aviso: Este conteúdo é educativo e visa o fortalecimento da autonomia emocional.*`,
  ...
  {
    id: 'art-bem-estar-4',
    slug: 'como-criar-uma-rotina-emocionalmente-saudavel',
    title: 'Como criar uma rotina emocionalmente saudável',
    summary: 'Construa um cotidiano equilibrado que combine compromissos, momentos de respiro, afeto e descanso sem cair no perfeccionismo rígido.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 6,
    readTimeMinutes: 6,
    keywords: ['rotina saudavel', 'equilibrio', 'organizacao', 'flexibilidade', 'emocoes'],
    tags: ['bem-estar', 'rotina', 'organizacao', 'habitos'],
    relatedArticleIds: ['como-praticar-autocuidado-em-uma-rotina-corrida', 'descansar-tambem-faz-parte-da-produtividade', 'como-criar-habitos-de-autocuidado-duradouros'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Muitas pessoas associam rotina a monotonia, aprisionamento ou tabelas rígidas que causam frustração ao primeiro imprevisto. No entanto, na psicologia, uma rotina bem desenhada funciona como uma rede de proteção emocional: ela poupa sua mente de tomar centenas de decisões triviais e traz previsibilidade e segurança ao seu sistema nervoso.
...
*Aviso: Este conteúdo é educativo e visa apoiar a organização pessoal.*`,
  ...
  {
    id: 'art-bem-estar-5',
    slug: 'descansar-tambem-faz-parte-da-produtividade',
    title: 'Descansar também faz parte da produtividade',
    summary: 'Desconstrua a culpa pelo repouso e compreenda como o descanso estratégico potencializa a criatividade, a memória e a clareza mental.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['descanso', 'produtividade', 'culpa', 'criatividade', 'recuperacao'],
    tags: ['bem-estar', 'produtividade', 'descanso', 'mente'],
    relatedArticleIds: ['como-ter-uma-relacao-saudavel-com-a-produtividade', 'a-importancia-das-pequenas-pausas-durante-o-dia', 'como-diminuir-a-sobrecarga-mental'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
...
*Aviso: Este conteúdo é educativo e visa a reflexão sobre autocuidado e saúde.*`,
  ...
  {
    id: 'art-bem-estar-6',
    slug: 'como-diminuir-a-sobrecarga-mental',
    title: 'Como diminuir a sobrecarga mental',
    summary: 'Aprenda a mapear e descarregar o peso invisível das mil tarefas, prazos e responsabilidades que lotam sua cabeça todos os dias.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['sobrecarga mental', 'trabalho invisivel', 'organizacao', 'delegar', 'clareza'],
    tags: ['bem-estar', 'mente', 'organizacao', 'autocuidado'],
    relatedArticleIds: ['descansar-tambem-faz-parte-da-produtividade', 'como-praticar-autocuidado-em-uma-rotina-corrida', 'como-aprender-a-respeitar-os-proprios-limites'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
...
*Aviso: Este conteúdo é educativo e visa a melhoria da qualidade de vida.*`,
  ...
  {
    id: 'art-bem-estar-7',
    slug: 'movimento-e-atividade-fisica-para-o-bem-estar',
    title: 'Movimento e atividade física para o bem-estar',
    summary: 'Compreenda a relação direta entre o movimento do corpo e a regulação do humor, da ansiedade e da neuroquímica cerebral.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['atividade fisica', 'movimento', 'endorfina', 'saude mental', 'exercicio'],
    tags: ['bem-estar', 'corpo', 'exercicio', 'saude'],
    relatedArticleIds: ['habitos-durante-o-dia-que-ajudam-a-dormir-melhor', 'como-criar-uma-rotina-emocionalmente-saudavel', 'gratidao-sem-ignorar-as-emocoes-dificeis'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Durante muito tempo, o exercício físico foi promovido na sociedade quase exclusivamente por motivos estéticos ou de perda de peso. No entanto, para a neurociência e a psiquiatria contemporâneas, o movimento corporal é a intervenção biológica mais potente e transformadora para o cérebro humano.
...
*Aviso: Consulte um profissional de educação física e médico antes de iniciar programas intensos de exercícios.*`,
  ...
  {
    id: 'art-bem-estar-8',
    slug: 'como-ter-uma-relacao-saudavel-com-a-produtividade',
    title: 'Como ter uma relação saudável com a produtividade',
    summary: 'Aprenda a produzir com significado e foco sem vincular seu valor como pessoa à quantidade de tarefas concluídas na lista.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['produtividade toxica', 'significado', 'perfeccionismo', 'autoestima', 'equilibrio'],
    tags: ['bem-estar', 'produtividade', 'carreira', 'mente'],
    relatedArticleIds: ['descansar-tambem-faz-parte-da-produtividade', 'como-aprender-a-respeitar-os-proprios-limites', 'como-diminuir-a-sobrecarga-mental'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
...
*Aviso: Este conteúdo é educativo e visa à promoção da saúde emocional no trabalho.*`,
  ...
  {
    id: 'art-bem-estar-9',
    slug: 'gratidao-sem-ignorar-as-emocoes-dificeis',
    title: 'Gratidão sem ignorar as emoções difíceis',
    summary: 'Descubra a diferença entre a verdadeira gratidão reflexiva e o otimismo tóxico que tenta silenciar a dor e o luto legítimos.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['gratidao', 'positividade toxica', 'emocoes dificeis', 'autenticidade', 'acolhimento'],
    tags: ['bem-estar', 'emocional', 'mente', 'acolhimento'],
    relatedArticleIds: ['como-acolher-emocoes-desconfortaveis', 'como-identificar-e-nomear-suas-emocoes', 'como-criar-uma-rotina-emocionalmente-saudavel'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
...
*Aviso: Este conteúdo é educativo e voltado para a saúde emocional.*`,
  ...
  {
    id: 'art-bem-estar-10',
    slug: 'como-criar-habitos-de-autocuidado-duradouros',
    title: 'Como criar hábitos de autocuidado duradouros',
    summary: 'Entenda a ciência da formação de hábitos, o poder das metas pequenas e como manter a consistência sem depender da motivação volátil.',
    category: 'Bem-estar',
    categoryName: 'Bem-estar',
    readingTimeMinutes: 5,
    readTimeMinutes: 5,
    keywords: ['habitos duradouros', 'consistencia', 'neurociencia', 'pequenas mudancas', 'rotina'],
    tags: ['bem-estar', 'habitos', 'estilo de vida', 'consistencia'],
    relatedArticleIds: ['como-praticar-autocuidado-em-uma-rotina-corrida', 'como-criar-uma-rotina-emocionalmente-saudavel', 'a-importancia-das-pequenas-pausas-durante-o-dia'],
    status: 'published',
    updatedAt: '2026-08-23T10:00:00Z',
    publishedAt: '2026-08-20T08:00:00Z',
    author: 'Equipe de Psicologia Respira',
    reviewedBy: 'Dra. Camila Nogueira (CRP 06/142980)',
    content: `Todo início de ano ou de mês nos enchemos de entusiasmo e planejamos mudanças radicais: meditar 45 minutos todo dia, cortar completamente o açúcar, acordar às 5h da manhã e ler 50 páginas por noite. Duas semanas depois, a rotina atropela esses planos e a frustração toma conta.
