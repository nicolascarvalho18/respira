...
export const SOUNDSCAPES: Soundscape[] = [
  ...
  // 6. Cachoeira distante
  {
    ...
    subtitle: 'Queda-d’água contínua ouvida à distância',
  ...
  // 7. Floresta
  {
    ...
    name: 'Floresta',
    subtitle: 'Folhas, pássaros e ambiente natural discreto',
  ...
  // 9. Fogueira
  {
    ...
    audioUrl: 'https://cdn.pixabay.com/download/audio/2022/01/18/audio_84a56c4d81.mp3?filename=fireplace-crackling-ambient-8321.mp3',
  ...
  // 10. Vento suave
  {
    ...
    audioUrl: 'https://cdn.pixabay.com/download/audio/2022/08/02/audio_884d6b6379.mp3?filename=soft-wind-breeze-11234.mp3',
  ...
  // 11. Tempestade distante
  {
    ...
    subtitle: 'Chuva forte com trovões distantes e moderados',
  ...
  // 12. Cafeteria
  {
    ...
    name: 'Cafeteria',
    subtitle: 'Ambiente discreto de cafeteria, sem conversas compreensíveis',
  ...
  // 15. Ruído rosa
  {
    ...
    audioUrl: 'https://cdn.pixabay.com/download/audio/2022/06/15/audio_24e931e289.mp3?filename=pink-noise-soft-5432.mp3',
  ...
  // 16. Ruído marrom
  {
    ...
    name: 'Ruído marrom',
    subtitle: 'Frequência mais grave, profunda e constante',
